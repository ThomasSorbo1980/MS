      ...
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden lg:flex items-center gap-8">
          {['Problem', 'Post-Audit', 'Validation', 'Pre-Audit', 'Clearing'].map((item) => (
            <a key={item} href={`#${item.toLowerCase().replace(' ', '-')}`} className="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-white transition-colors">{item}</a>
          ))}
  ...
  return (
    <div className="relative">
      ...
      <section className="relative h-screen flex items-center overflow-hidden bg-slate-950">
        ...
        <motion.div style={{ y: shipY }} className="absolute -bottom-40 -right-40 opacity-5 pointer-events-none hidden lg:block">
           <Ship size={1200} strokeWidth={0.5} className="text-blue-500" />
        </motion.div>
      </section>
      ...
      <section id="impact" className="py-32 bg-[#020617] border-y border-white/5">
        <div className="container mx-auto px-6">
